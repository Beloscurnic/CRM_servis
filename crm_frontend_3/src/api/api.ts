...
export class Client extends ClientBase {
    ...
    create(api_version: string, body: Create_Order_ClientDto | undefined): Promise<string> {
        let url_ = this.baseUrl + "/api/{version}/Order_Client/create";
        if (api_version === undefined || api_version === null)
            throw new Error("The parameter 'api_version' must be defined and cannot be null.");
        url_ = url_.replace('{version}', encodeURIComponent('' + api_version));
        url_ = url_.replace(/[?&]$/, '');
     ...
     * @return Success
     */
    update_status1(api_version: string, body: Update_Order_ClientDto): Promise<void> {
        let url_ = this.baseUrl + "/api/{version}/Order_Client/Update_Order_Client";
        if (api_version === undefined || api_version === null)
        throw new Error("The parameter 'api_version' must be defined and cannot be null.");
    url_ = url_.replace('{version}', encodeURIComponent('' + api_version));
    url_ = url_.replace(/[?&]$/, '');
     ...
     * @return Success
     */
      update_status(api_version: string, body: Update_Status_orderDto): Promise<void> {
        let url_ = this.baseUrl + "/api/{version}/Order_Client/update_status";
        if (api_version === undefined || api_version === null)
        throw new Error("The parameter 'api_version' must be defined and cannot be null.");
    url_ = url_.replace('{version}', encodeURIComponent('' + api_version));
    url_ = url_.replace(/[?&]$/, '');
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processUpdate_status(_response);
        });
    }

    protected processUpdate_status(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
    ...
    get(id: number, api_version: string): Promise<Order_Client_DetailsVm> {
    ...
    personnalAll(api_version: string): Promise<List_PersonnalVm> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processPersonnalAll(_response);
        });
    }

    protected processPersonnalAll(response: Response): Promise<List_PersonnalVm> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 201 || status === 200) {
            return response.text().then((_responseText) => {
    ...
    personnal(id: string | unknown, api_version: string): Promise<PersonnalVm> {
...
export interface List_PersonnalVm {
    list_Personnals: List_Personnal[] ;
}
...
export interface Update_Status_orderDto {
    iD_Order: number;
