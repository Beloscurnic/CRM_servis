...
for (let i = 0; i < orders!.length; i++) {
    ...
    structur[i] = {
        ...
        name_Client: orders![i]['name_Client'],
        lastName_Client: orders![i]['lastName_Client']
    };
}
    ...
    const columns = [
        ...
        {dataField : 'name_Client', text :'Имя'},
        {dataField : 'lastName_Client', text :'Фамилия'},
        {dataField : 'telefon', text :'Телефон'},
    ];
    ...
    return (
        <div>
            ...
            <section>
                 ...
                 {/* 
                     {orders?.filter(person => person.status_Order =="jjhkjh" && person.lastName_Client =="jjhkjh").map((order) => (
                 <tr>
                     {orders?.map(order=>{
